...
OUTPUT = ROOT / "docs/research/agent-mesh-paper-v1.10.docx"
...
def build():
    ...
    set_font(header.add_run("Agent Mesh | Preprint v1.10"), 8.5, color=MUTED)
    ...
    doc.core_properties.comments = "Version 1.10 prepared for archival publication on Zenodo."
    doc.save(OUTPUT)
    print(OUTPUT)
