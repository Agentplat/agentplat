...
export async function assertReleaseLine({
  ...
  assert.ok(
    line,
    `Release line requires exactly 29 Alpha 3 packages without ${TRUST_PACKAGE_NAME}, 30 Alpha 4 packages, 33 Alpha 5 packages, 34 Beta 1 packages, 36 Beta 2 packages, or 37 Beta 3 packages with it exactly once`
  );
