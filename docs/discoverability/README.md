...
See [the raw HTTP baseline](http-baseline-2026-09-07.json), the
[route-aware follow-up](http-baseline-routes-2026-09-07.json) and
[implementation validation](validation.md). This is direct HTTP
