...
| `work.progress`               | current Work Item revision and assignment epoch                          | accepted award or acceptance ID                             |     lesser of 5 minutes or remaining lease | Append-only status; it cannot extend a lease                                                              |
| `work.checkpoint`             | current Work Item revision and assignment epoch                          | accepted award plus preceding checkpoint ID when one exists |     lesser of 5 minutes or remaining lease | Append-only checkpoint; compaction preserves its digest chain                                             |
| `work.result`                 | current Work Item revision and assignment epoch                          | accepted award or acceptance ID and applicable checkpoint   |     lesser of 5 minutes or remaining lease | Immutable result; later verification or evidence may accept or contest it without rewriting it            |
