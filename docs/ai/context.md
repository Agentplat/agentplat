...
| AgentPlat Agent Morphogenesis | Governed mission-scoped organizational evolution | `@agentplat/collective-runtime/morphogenesis`, `docs/adr/0046-agent-morphogenesis.md` |
