CREATE TABLE IF NOT EXISTS __AGENTPLAT_SCHEMA__.collective_sparse_runtime_states (
...
CREATE INDEX IF NOT EXISTS collective_sparse_runtime_updated_idx
  ON __AGENTPLAT_SCHEMA__.collective_sparse_runtime_states
