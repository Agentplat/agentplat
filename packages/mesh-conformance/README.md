...
`./protocol`, `./transport`, `./durability`, `./rooms` and `./control` expose
bounded runners. A passing report describes only the exact artifact,
capabilities, fixtures and cases that were executed; it is not a security
certification.
