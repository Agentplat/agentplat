// Adapted from tests/morphogenesis.test.mjs fixture at e978544915a329387e13883fa352191f6993dcc7.
// Synthetic source observations; real constructors and exact decision bindings.
import {
...
export function fixture(label, teamPositionDigest) {
  ...
  const target = createTargetMorphologyV1(
    {
      ...
      positions: [position],
      agentDispositions: [],
      invariantDigests: [teamPositionDigest],
  ...
  const operation = createMorphogenesisOperationV1(
    {
      operationId: `operation:recruit:${label}`,
