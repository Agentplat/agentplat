...
const policy = createMorphogenesisAgentGenesisPolicyV6({ schemaVersion: 6,
  policyId: "policy:agent-genesis:example", policyVersion: 1, parentPolicyDigest: null,
  ...
  maximumActionBudgetUnits: 3, maximumDraftTtlMs: 60_000,
...
const need = createMorphogenesisAgentGenesisNeedV6({ needId: "need:agent-genesis:example",
  scopeDigest: digest("scope"), morphogenesisNeedDigest: digest("need"),
  strategyCandidateDigest: digest("strategy-v5"),
  strategyCertificationDigest: digest("strategy-v5-certification"),
  evaluatedBlueprintDigests: [digest("catalog-blueprint")], eligibleBlueprintDigests: [],
...
console.log(JSON.stringify({ needId: need.needId, needDigest: need.needDigest,
  genesisRequired: need.genesisRequired, advisoryOnly: need.advisoryOnly,
